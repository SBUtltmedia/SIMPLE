<p>
Click <a href="includes/Simpl-Photoshop-tutorial.pdf">here</a> for a SIMPLE tutorial using Adobe Photoshop.
<br/><br/>
...
<br/>
<br/><img align="center" src="includes/sforge1.PNG">
<br/>
<br/>and then you'll see something that looks like this:
<br/><br/><img src="includes/sforge2.PNG">
<br/>
...
<br/><img src="includes/GIMPexe1.PNG">
...
<br/><br/><img src="includes/GIMPexe2.PNG">
<br/>
...
<br/><br/><img src="includes/GIMPexe3.PNG">
<br/>
<br/>now's a good time to get a cup of coffee
</p>
<h1><a name="gettingtoknowgimp"></a>Getting to Know GIMP <img src="includes/theGIMP.png" align="center"></h1>
<h2><a name="whereami"></a>Where am I?</h2>
<p>
By now you should be looking at two windows.  The tops should look like the ones below:
<br/><br/><img src="includes/window1.PNG">
<br/>
...
<br/><br/><img src="includes/workspace2.PNG">
<br/>
<br/>Another way to make a new layers window is by selecting File>Dialogs>Layers in the main window.
<br/><br/><img src="includes/workspace1.PNG">
<br/>
</p>
<h2><a name="selecting"></a>Selecting</h2>
<p>
There are 7 selection tools that we can use to cut and paste.
<br/><img src="includes/select1.PNG" align="bottom">shortcut:R - allows you to select a rectangular region by dragging diagonally across the screen
<br/><img src="includes/select2.PNG" align="bottom">shortcut:E - allows you to select elliptical regions by dragging diagonally across the screen
<br/><img src="includes/select3.PNG" align="bottom">shortcut:F - create a selection by drawing it free-hand while holding down the mouse, when you let go, it will close the region by drawing a straight line from the point where you let go to the point where you first clicked down
<br/><img src="includes/select4.PNG" align="bottom">shortcut:Z - select a contiguous area of similar color using just one click
<br/><img src="includes/select5.PNG" align="bottom">shortcut:Shift+O - select all areas of similar color using one click
<br/><img src="includes/select6.PNG" align="bottom">shortcut:I - instead of tracing an object's outline by freehand, you can click various points along a boundary and this will make a line that sticks like a magnet to the shape of the boundary, creating a selection of the same shape
<br/><img src="includes/select7.PNG" align="bottom">shortcut:B - this last tool isn't really a selection tool, but can be used as one.  using the Path Tool, you can create paths that can be used to draw lines, select shapes, or can even be saved to be used later for other uses.  You can create a line from placing nodes, and then go back and edit the nodes to make a smooth, curved path.
</p>
<h2><a name="layers"></a>Layers</h2>
<p>
If you look at the Layers window, you can see what looks like a left-pointing triangle:
<br/><br/><img src="includes/layers1.png">
<br/>
...
<br/><br/><img src="includes/layers2.png">
<br/></p>
<h2><a name="saving"></a>Saving</h2>
<p>
As soon as you open an image, save it!
<br/><br/><img src="includes/saving2.PNG">
<br/>
...
<br/><br/><img src="includes/importing2.gif">
<br/>
...
<br/><br/><img src="includes/cropanim.gif">
<br/>
...
<br/><br/><img src="includes/layer0.gif">
<br/>
...
<br/><br/><img src="includes/tracing1.PNG">
<br/>
...
<br/><br/><img src="includes/outlining.gif">
...
<br/><br/><img src="includes/merge.png">
<br/>
...
<br/><br/><img src="includes/invert.png">
<br/>
...
<br/><br/><img src="includes/fill1.png">
<br/>
...
<br/><br/><img src="includes/Filters1.png">
<br/>
...
Go to File>Save as 
<br/><br/><img src="includes/savepsd2.png">
<br/>
<br/>select "Photoshop image" under "Select File Type"
<br/><br/><img src="includes/savepsd.png">
<br/>
<br/>
<br/>
